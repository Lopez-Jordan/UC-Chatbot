...
export default function Modal({ isModalOpen, setIsModalOpen, setCommentary, commentary, JSONscoreArr }) {
    ...
    <>
      <div className="modal-overlay">
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          <button id="modalButtonX" onClick={handleModalClose}>x</button>
          <div className='mainContentModal'>
            ...
            <div className='RightScore'>
              ...
              <p className='content'>{commentary}</p>
            </div>
          </div>
